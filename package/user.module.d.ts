...
export declare class UserModule implements OnModuleInit {
    ...
    constructor(userService: UserService, modulesContainer: ModulesContainer, resourceRepo: Repository<Resource>, permissionRepo: Repository<Permission>, roleRepo: Repository<Role>, infoGroupRepo: Repository<InfoGroup>, userRepo: Repository<User>);
